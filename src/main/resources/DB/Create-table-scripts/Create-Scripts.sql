...
CREATE TABLE `customer` (
  ...
  `CUTOMER_FIRST_NAME` varchar(100) NOT NULL,
  ...
  `INSURANCE_POLICY_PERSONAL_ID` int(11) DEFAULT NULL,
  `MEMBERSHIP_CARD_PERSONAL_ID` int(11) DEFAULT NULL,
  ...
  KEY `FK_CUSTOMER_PHARMACY` (`PHARMACY_ID`),
  KEY `FK_CUSTOMER_CUSTOMER_MEMBERSHIP` (`MEMBERSHIP_CARD_PERSONAL_ID`),
  KEY `FK_CUSTOMER_CUSTOMER_INSURANCE` (`INSURANCE_POLICY_PERSONAL_ID`),
  ...
  CONSTRAINT `FK_CUSTOMER_CUSTOMER_INSURANCE_LOOKUP` FOREIGN KEY (`INSURANCE_POLICY_PERSONAL_ID`) REFERENCES `customer_insurance` (`INSURANCE_POLICY_ID`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `FK_CUSTOMER_CUSTOMER_MEMBERSHIP_LOOKUP` FOREIGN KEY (`MEMBERSHIP_CARD_PERSONAL_ID`) REFERENCES `customer_membership` (`MEMBERSHIP_CARD_PERSONAL_ID`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `FK_CUSTOMER_PHARMACY_LOOKUP` FOREIGN KEY (`PHARMACY_ID`) REFERENCES `pharmacy` (`PHARMACY_ID`) ON DELETE RESTRICT ON UPDATE RESTRICT,
...
CREATE TABLE `customer_insurance` (
  ...
  `INSURANCE_POLICY_PERSONAL_ID` int(11) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`INSURANCE_POLICY_PERSONAL_ID`),
...
CREATE TABLE `customer_membership` (
  `CUSTOMER_ID` int(11) DEFAULT NULL,
  `MEMBERSHIP_CARD_PERSONAL_ID` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `MEMBERSHIP_CREDIT_DAYS` int(11) DEFAULT NULL,
  PRIMARY KEY (`MEMBERSHIP_CARD_PERSONAL_ID`),
...
CREATE TABLE `distributor` (
  ...
  `DISTRIBUTOR_ALSO_MANUFACTURER` char(1) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT 'N',
...
CREATE TABLE `distributor_contract` (
  `DISTRIBUTOR_CONTRACT_ID` int(11) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`DISTRIBUTOR_CONTRACT_ID`),
  KEY `FK_DISTRIBUTOR_CONTRACT_DISTRIBUTOR` (`DISTRIBUTOR_ID`),
  KEY `FK_DISTRIBUTOR_CONTRACT_QUOTATION` (`QUOTATION_ID`),
  CONSTRAINT `FK_DISTRIBUTOR_CONTRACT_DISTRIBUTOR` FOREIGN KEY (`DISTRIBUTOR_ID`) REFERENCES `distributor` (`DISTRIBUTOR_ID`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `FK_DISTRIBUTOR_CONTRACT_QUOTATION` FOREIGN KEY (`QUOTATION_ID`) REFERENCES `quotation` (`QUOTATION_ID`) ON DELETE RESTRICT ON UPDATE RESTRICT
);

DROP TABLE IF EXISTS `distributor_contract_items`;
CREATE TABLE `distributor_contract_items` (
  `DISTRIBUTOR_CONTRACT_ITEM_ID` int(11) NOT NULL AUTO_INCREMENT,
  `DISTRIBUTOR_ID` int(11) DEFAULT NULL,
  `DISTRIBUTOR_CONTRACT_ID` int(11) DEFAULT NULL,
  ...
  `LAST_UPDATE_USER_ID` varchar(50) DEFAULT NULL,
  `AUDIT_ID` int(11) DEFAULT NULL,
  `CURRENT_DISTRIBUTOR` char(1) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT 'Y',
  `UNIT_TAX` float DEFAULT NULL,
  `QTY_BONUS` int(11) DEFAULT NULL,
  `DISCOUNT` float DEFAULT NULL,
  `DISCOUNT_PERCENTAGE` float DEFAULT NULL,
  `APPROVED_DISTRIBUTOR` char(1) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT 'Y',
  PRIMARY KEY (`DISTRIBUTOR_CONTRACT_ITEM_ID`),
  KEY `FK_DISTRIBUTOR_CONTRACT_ITEM_CONTRACT` (`DISTRIBUTOR_CONTRACT_ID`),
  KEY `FK_DISTRIBUTOR_CONTRACT_ITEM_DISTRIBUTOR` (`DISTRIBUTOR_ID`),
  KEY `FK_DISTRIBUTOR_CONTRACT_ITEM_ITEMS` (`ITEM_ID`),
  CONSTRAINT `FK_DISTRIBUTOR_CONTRACT_ITEM_CONTRACT` FOREIGN KEY (`DISTRIBUTOR_CONTRACT_ID`) REFERENCES `distributor_contract` (`DISTRIBUTOR_CONTRACT_ID`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `FK_DISTRIBUTOR_CONTRACT_ITEM_DISTRIBUTOR` FOREIGN KEY (`DISTRIBUTOR_ID`) REFERENCES `distributor` (`DISTRIBUTOR_ID`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `FK_DISTRIBUTOR_CONTRACT_ITEM_ITEMS` FOREIGN KEY (`ITEM_ID`) REFERENCES `items` (`ITEM_ID`) ON DELETE RESTRICT ON UPDATE RESTRICT
);
...
CREATE TABLE `invoice` (
  ...
  KEY `FK_PURCHASE_INVOICE_DISTRIBUTOR` (`DISTRIBUTOR_ID`),
  ...
  CONSTRAINT `FK_PURCHASE_INVOICE_DISTRIBUTOR` FOREIGN KEY (`DISTRIBUTOR_ID`) REFERENCES `distributor` (`DISTRIBUTOR_ID`) ON DELETE RESTRICT ON UPDATE RESTRICT,
...
CREATE TABLE `items_distributor` (
  ...
  `LAST_UPDATE_USER_ID` varchar(50) DEFAULT NULL,
  `ACTIVE_S` char(1) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `DISTRIBUTOR_PRIORITY` int(11) DEFAULT NULL,
...
CREATE TABLE `purchase_order` (
  ...
  KEY `FK_PURCHASE_ORDER_VERIFI_BY` (`VERIFY_BY`),
  KEY `FK_PURCHASE_ORDER_PHARMACY_ADDRESS` (`PHARMACY_ADDRESS_ID`),
  ...
  CONSTRAINT `FK_PURCHASE_ORDER_CANCELLED_BY` FOREIGN KEY (`CANCELLED_BY`) REFERENCES `employee` (`EMPLOYEE_ID`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  ...
  CONSTRAINT `FK_PURCHASE_ORDER_DISTRIBUTOR` FOREIGN KEY (`DISTRIBUTOR_ID`) REFERENCES `distributor` (`DISTRIBUTOR_ID`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  ...
  CONSTRAINT `FK_PURCHASE_ORDER_PHARMACY_ADDRESS` FOREIGN KEY (`PHARMACY_ADDRESS_ID`) REFERENCES `pharmacy_address` (`PHARMACY_ADDRESS_ID`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  ...
  CONSTRAINT `FK_PURCHASE_ORDER_VERIFI_BY` FOREIGN KEY (`VERIFY_BY`) REFERENCES `employee` (`EMPLOYEE_ID`) ON DELETE RESTRICT ON UPDATE RESTRICT
);
...
CREATE TABLE `purchase_order_items` (
  ...
  CONSTRAINT `FK_PURCHASE_ORDER_ITEMS_TAX` FOREIGN KEY (`TAX`) REFERENCES `tax` (`TAX_ID`) ON DELETE RESTRICT ON UPDATE RESTRICT
);
...
CREATE TABLE `quotation` (
  ...
  KEY `FK_QUOTATION_CANCELLED_BY` (`CANCELLED_BY`),
  ...
  CONSTRAINT `FK_QUOTATION_CANCELLED_BY` FOREIGN KEY (`CANCELLED_BY`) REFERENCES `employee` (`EMPLOYEE_ID`) ON DELETE RESTRICT ON UPDATE RESTRICT,
...
CREATE TABLE `quotation_items` (
  ...
  KEY `FK_QUOTATION_ITEMS_DISTRIBUTOR` (`DISTRIBUTOR_ID`),
  ...
  CONSTRAINT `FK_QUOTATION_ITEMS_DISTRIBUTOR` FOREIGN KEY (`DISTRIBUTOR_ID`) REFERENCES `distributor` (`DISTRIBUTOR_ID`) ON DELETE RESTRICT ON UPDATE RESTRICT,
