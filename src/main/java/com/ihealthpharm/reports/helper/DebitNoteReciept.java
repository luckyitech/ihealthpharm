...
@Component
@Slf4j
public class DebitNoteReciept extends ReportsPDFUtility {
	...
	private void addCreditNoteDetails(Document document, ReportsMappingModel model, Map<String, Object> responseList) throws DocumentException {
		String debitNoteNo = (ObjectUtils.isEmpty(responseList))?"":String.valueOf(responseList.get("debit_note_no"));
		String supplierName = (ObjectUtils.isEmpty(responseList))?"":String.valueOf(responseList.get("SP_NAME"));
		String debitNoteDate = (ObjectUtils.isEmpty(responseList))?"":String.valueOf(responseList.get("debit_date"));
		String purchaseInvoiceNo = (ObjectUtils.isEmpty(responseList))?"":String.valueOf(responseList.get("invoice_id"));
		...
		cell = new PdfPCell(new Phrase(debitNoteNo,bold));
		cell.setHorizontalAlignment(Element.ALIGN_LEFT);
		cell.setColspan(2);
		cell.setBorder(Rectangle.TOP);
		table.addCell(cell);
		...
		cell = new PdfPCell(new Phrase("Debit Date		:",bold));
		cell.setHorizontalAlignment(Element.ALIGN_LEFT);
		cell.setColspan(2);
		cell.setBorder(Rectangle.NO_BORDER);
		table.addCell(cell);

		cell = new PdfPCell(new Phrase(debitNoteDate,bold));
		cell.setHorizontalAlignment(Element.ALIGN_LEFT);
		cell.setColspan(2);
		cell.setBorder(Rectangle.NO_BORDER);
		table.addCell(cell);
		...
		cell = new PdfPCell(new Phrase(purchaseInvoiceNo,bold));
		cell.setHorizontalAlignment(Element.ALIGN_LEFT);
		cell.setColspan(2);
		cell.setBorder(Rectangle.NO_BORDER);
		table.addCell(cell);
