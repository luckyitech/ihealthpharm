...
@Component
@Slf4j
public class SalesReturnReciept extends ReportsPDFUtility{
	@Override
...
//		table.setWidths(new int[] {10,30,10,10,10,10});
		...
		if (!ObjectUtils.isEmpty(responseList)) {
			for (Map<String, Object> rowData : responseList) {
					...
					Object value = String.valueOf(responseList.indexOf(rowData) + 1);
