...
@Component
public class PrintPurchaseOrderReceipt extends ReportsPDFUtility{
		...
		try {
			...
			if(!ObjectUtils.isEmpty(headerContent)) {
				...
				for(HeaderFooterContentDetailsDto dto:contentDto.getLeftContent()) {		
					...
					}else if(dto.getText().contains("Purchase Order")){
						leftContent.addElement(new Phrase(dto.getText()+" "+responseList.get(0).get("PURCHASE_ORDER_NO"),bold));
					}else {
	...
	private void createTable(Document document, ReportsMappingModel model, List<Map<String, Object>> purchaseOrderDetailsList,
		...
		PdfPTable supplierDetailTable1 = new PdfPTable(4);
		
		PdfPTable supplierDetailTable2 = new PdfPTable(4);
		PdfPTable supplierDetailTable3 = new PdfPTable(4);
		PdfPTable supplierDetailTable4 = new PdfPTable(2);
		...
		PdfPCell nameCell4 = new PdfPCell(new Phrase("Created By  : "+purchaseOrderDetailsList.get(0).get("CREATED_BY"),title08)); 
		PdfPCell nameCell5 = new PdfPCell(new Phrase("Modified By  : "+purchaseOrderDetailsList.get(0).get("MODIFIED_BY"),title08)); 
		PdfPCell nameCell6 = new PdfPCell(new Phrase("Approved By  : "+purchaseOrderDetailsList.get(0).get("APPROVED_BY"),title08)); 
		...
		supplierDetailTable1.addCell(nameCell);
		supplierDetailTable1.addCell(nameCell4);
		supplierDetailTable1.setLockedWidth(true);
		supplierDetailTable1.setTotalWidth(500);
		supplierDetailTable1.getDefaultCell().setBorder(0); 
		
		supplierDetailTable2.addCell(nameCell1);
		supplierDetailTable2.addCell(nameCell5);
		supplierDetailTable2.setLockedWidth(true);
		supplierDetailTable2.setTotalWidth(500);
		supplierDetailTable2.getDefaultCell().setBorder(0); 
		
		supplierDetailTable3.addCell(nameCell2);
		supplierDetailTable3.addCell(nameCell6);
		supplierDetailTable3.setLockedWidth(true);
		supplierDetailTable3.setTotalWidth(500);
		supplierDetailTable3.getDefaultCell().setBorder(0); 
		
		supplierDetailTable4.addCell(nameCell3);
		supplierDetailTable4.setLockedWidth(true);
		supplierDetailTable4.setTotalWidth(500);
		supplierDetailTable4.getDefaultCell().setBorder(0); 
		...
		finalTable.addCell(supplierDetailTable1);
		finalTable.addCell(supplierDetailTable2);
		finalTable.addCell(supplierDetailTable3);
		finalTable.addCell(supplierDetailTable4);
