	...
	public Document generateReport(List<Map<String, Object>> responseList, ReportsMappingModel model,
		...
		try {
			...
			if(!ObjectUtils.isEmpty(purchaseDetailsByBatchNo)) { 
				...
				for(String batchNo :purchaseDetailsByBatchNo.keySet()) {					
					List<Map<String, Object>> purchaseDetails = purchaseDetailsByBatchNo.get(batchNo);
					createTable(document,model,purchaseDetails,batchNo);
				}
