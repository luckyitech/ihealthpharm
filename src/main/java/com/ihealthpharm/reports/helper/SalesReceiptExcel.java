...
@Component
public class SalesReceiptExcel extends ReportsExcelUtility{
	...
	private void addBillTotals(SXSSFSheet sheet, File responseFile, CellStyle borderStyle, ReportsMappingModel model,
		...
		Cell cell_status=dataRow4.createCell(3);
		Cell cell_tax=dataRow6.createCell(0);
		Cell cell_taxValueA=dataRow7.createCell(0);
		Cell cell_taxValueB=dataRow7.createCell(1);
		Cell cell_taxValueE=dataRow7.createCell(2);

		cell_totItems.setCellValue("Total Items");
		cell_totQty.setCellValue("Total Qty");
		cell_vatAmt.setCellValue("Vat Amt");
		cell_balAmt.setCellValue("Bal Amt");
		cell_servBy.setCellValue("Serv By");
		cell_printBy.setCellValue("Print By");
		cell_totAmt.setCellValue("Total Amt");
		cell_totDisc.setCellValue("Total Disc");
		cell_netAmt.setCellValue("Net Amt");
		cell_paidAmt.setCellValue("Paid Amt");
		cell_status.setCellValue("Paid Status");
		cell_tax.setCellValue("Tax Codes");
		cell_taxValueA.setCellValue("A = "+totalAValue);
		cell_taxValueB.setCellValue("B = "+totalBValue);
		cell_taxValueE.setCellValue("E = "+totalEValue);
		...
		cell_status=dataRow4.createCell(4);
		cell_tax=dataRow6.createCell(1);
		Cell cell_tax1=dataRow6.createCell(2);
		Cell cell_tax2=dataRow6.createCell(3);

		cell_totItems.setCellValue(String.valueOf(totalItems));
		cell_totQty.setCellValue(String.valueOf(totalQty));
		cell_vatAmt.setCellValue(String.valueOf(totalVat));
		cell_balAmt.setCellValue(String.valueOf(balanceAmt));
		cell_servBy.setCellValue(String.valueOf(servBy));
		cell_printBy.setCellValue(String.valueOf(printedBy));
		cell_totAmt.setCellValue(String.valueOf(totalAmount));
		cell_totDisc.setCellValue(String.valueOf(totalDiscount));
		cell_netAmt.setCellValue(String.valueOf(totalNetAmount));
		cell_paidAmt.setCellValue(String.valueOf(paidAmt));
		cell_status.setCellValue(String.valueOf(paymentStatus));
		cell_tax.setCellValue("A-14%");
		cell_tax1.setCellValue("B-0%");
		cell_tax2.setCellValue("E-Exempt");
