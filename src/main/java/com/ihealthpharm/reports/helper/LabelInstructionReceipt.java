...
//		
//		Font bolds = new Font(FontFamily.HELVETICA,7, Font.BOLD);
//		PdfPCell cell = new PdfPCell(new Phrase(" I : ",bold));
//		cell.setHorizontalAlignment(Element.ALIGN_LEFT);
//		cell.setBorder(Rectangle.TOP);
//		table.addCell(cell);
...
//		
//		PdfPCell  cell = new PdfPCell(new Phrase("Item  :",bold));
//		cell.setHorizontalAlignment(Element.ALIGN_LEFT);
//		cell.setBorder(Rectangle.TOP);
//		table.addCell(cell);
//		
//		cell = new PdfPCell(new Phrase(itemName,bold));
//		cell.setHorizontalAlignment(Element.ALIGN_LEFT);
//		cell.setBorder(Rectangle.TOP);
//		table.addCell(cell);
