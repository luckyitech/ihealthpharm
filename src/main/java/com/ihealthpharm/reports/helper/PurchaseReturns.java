...
@Component
public class PurchaseReturns extends ReportsPDFUtility{
...
//	private Image total;
	...
	public Document generateReport(List<Map<String, Object>> responseList, ReportsMappingModel model,
		...
		try {
			...
			Map<Date, List<Map<String, Object>>> purchaseInvoiceDetailsReturnDate = responseList.stream()
					.collect(Collectors.groupingBy(map -> (Date) map.get("PURCHASE_RETURN_DATE")));
			...
			if(!ObjectUtils.isEmpty(purchaseInvoiceDetails)) { 
				...
				for(Date returnDate :purchaseInvoiceDetailsReturnDate.keySet()) {	
					retDate=returnDate;
					List<Map<String, Object>> purchaseInvoiceDetailsMap = purchaseInvoiceDetails.get(suppName);
				}
				for(Date invoiceDate :purchaseInvoiceDetailsInvDate.keySet()) {	
					List<Map<String, Object>> purchaseInvoiceDetailsMap = purchaseInvoiceDetails.get(suppName);
					createTable(document,model,purchaseInvoiceDetailsMap,suppName,location,invNo,invoiceDate,retDate);
	...
	private void addHeader(PdfWriter writer, Document document,ReportsMappingModel model,List<Map<String, Object>> responseList) throws DocumentException {
		...
		String purchaseReturnNo = (ObjectUtils.isEmpty(responseList))?"":String.valueOf(responseList.get(0).get("PURCHASE_RETURN_NO"));
		...
		try {
			...
			if(!ObjectUtils.isEmpty(headerContent)) {
				...
				HeaderFooterContentDetailsDto PurRetNoData = new HeaderFooterContentDetailsDto();
				System.out.println("grnData is"+grnData);
	...
	private void createTable(Document document, ReportsMappingModel model, List<Map<String, Object>> purchaseInvoiceDetailsList,
			String supplierName,String address,String invoiceNo,Date invoiceDate,Date returnDate) throws DocumentException {
		...
		SimpleDateFormat formatter = new SimpleDateFormat("dd-MM-yyyy");
		 ...
		 String returnDates=formatter.format(returnDate);
			...
			PdfPCell nameCell = new PdfPCell(new Phrase("Supplier Name   :",title08));
			nameCell.setHorizontalAlignment(Element.ALIGN_LEFT);
			nameCell.setVerticalAlignment(Element.ALIGN_TOP);
			nameCell.setBorder(0);
			supllierNameTable.addCell(nameCell);
			
			nameCell = new PdfPCell(new Phrase(supplierName,title08));
			nameCell.setHorizontalAlignment(Element.ALIGN_LEFT);
			nameCell.setVerticalAlignment(Element.ALIGN_TOP);
			nameCell.setBorder(0);
			supllierNameTable.addCell(nameCell);
			
			nameCell = new PdfPCell(new Phrase("Invoice No   :",title08));
			nameCell.setHorizontalAlignment(Element.ALIGN_LEFT);
			nameCell.setVerticalAlignment(Element.ALIGN_TOP);
			nameCell.setBorder(0);
			supllierNameTable.addCell(nameCell);
			
			nameCell = new PdfPCell(new Phrase(invoiceNo,title08));
			nameCell.setHorizontalAlignment(Element.ALIGN_LEFT);
			nameCell.setVerticalAlignment(Element.ALIGN_TOP);
			nameCell.setBorder(0);
			supllierNameTable.addCell(nameCell);
			
			nameCell = new PdfPCell(new Phrase("Return Date   :",title08));
			nameCell.setHorizontalAlignment(Element.ALIGN_LEFT);
			nameCell.setVerticalAlignment(Element.ALIGN_TOP);
			nameCell.setBorder(0);
			supllierNameTable.addCell(nameCell);
			
			nameCell = new PdfPCell(new Phrase(returnDates,title08));
			nameCell.setHorizontalAlignment(Element.ALIGN_LEFT);
			nameCell.setVerticalAlignment(Element.ALIGN_TOP);
			nameCell.setBorder(0);
			supllierNameTable.addCell(nameCell);
			
			nameCell = new PdfPCell(new Phrase("Invoice Date   :",title08));
			nameCell.setHorizontalAlignment(Element.ALIGN_LEFT);
			nameCell.setVerticalAlignment(Element.ALIGN_TOP);
			nameCell.setBorder(0);
			supllierNameTable.addCell(nameCell);
			
			nameCell = new PdfPCell(new Phrase(invoiceDates,title08));
			nameCell.setHorizontalAlignment(Element.ALIGN_LEFT);
			nameCell.setVerticalAlignment(Element.ALIGN_TOP);
			nameCell.setBorder(0);
			supllierNameTable.addCell(nameCell);
			
			nameCell = new PdfPCell(new Phrase("Address   :",title08));
			nameCell.setHorizontalAlignment(Element.ALIGN_LEFT);
			nameCell.setVerticalAlignment(Element.ALIGN_TOP);
			nameCell.setBorder(0);
			supllierNameTable.addCell(nameCell);
			...
			nameCell = new PdfPCell(new Phrase("   ",title08));
			nameCell.setHorizontalAlignment(Element.ALIGN_LEFT);
			nameCell.setVerticalAlignment(Element.ALIGN_TOP);
			nameCell.setBorder(0);
			supllierNameTable.addCell(nameCell);
