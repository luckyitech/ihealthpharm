...
/**
 * @author Gunasekhar Controller is used to perform the crud operations of
 *         Invoices
 */
@RestController
@CrossOrigin
...
public class InvoiceController {
	...
	/**
	 * @author Gunasekhar Service is save the invoice, invoice items and stock
	 *         details
	 */
	...
	/**
	 * @author Gunasekhar Service is for update the Invoice
	 */
	...
	public ResponseEntity<BaseDto<InvoiceModel>> updateInvoice(@Valid @RequestBody InvoiceModel invoiceModel) {
		...
		PurchaseReturnModel purchaseReturnModel = invoiceModel.getPurchaseReturnModel();
		InvoiceModel model = invoiceService.updateInvoice(invoiceModel,purchaseReturnModel);
		return new BaseDto<>(model, invoiceHelper.getUpdateInvoiceMessage(), OK).respond();
	}

	/**
	 * @author Gunasekhar Service is for update the Invoices
	 */
	@PutMapping("/update/multipleinvoices")
	public ResponseEntity<BaseDto<List<InvoiceModel>>> updateInvoices(
			@Valid @RequestBody List<InvoiceModel> invoiceModels) {
	...
	/**
	 * @author Gunasekhar Service is for delete Invoice
	 */
	...
	/**
	 * @author Gunasekhar Service is for delete Invoices
	 */
	...
	/**
	 * @author Gunasekhar Service is for get all invoices
	 * 
	 */
	...
	/**
	 * @author Gunasekhar Service is for get invoice using invoiceId
	 */
	...
	/**
	 * @author Gunasekhar Service is for automatic generation of GRN Number
	 */
	...
	/**
	 * @author Gunasekhar Service is for automatic generation of Purchase return
	 *         Number
	 */
	...
	/**
	 * @author Gunasekhar Service is for get all invoices of particular pharmacy
	 */
	...
	/**
	 * @author Gunasekhar Service is for get all invoice items
	 */
	...
	@GetMapping("/getinvoicesbypharmacyandstatus")
	public ResponseEntity<BaseDto<List<InvoiceModel>>> getAllInvoicesByPharmacyAndInvoiceStatus(@RequestParam Integer pharmacyId, @RequestParam Integer invoiceStatusId,
			Integer pageNumber, Integer pageSize,String invoiceNo) {
		List<InvoiceModel> invoiceModels = invoiceService.findAllInvoicesByPharmacyIdAndInvoiceSatusId(pharmacyId,invoiceStatusId,pageNumber,pageSize,invoiceNo);
		return new BaseDto<>(invoiceModels, invoiceHelper.getRetrieveInvoiceMessage(), OK).respond();
	}

	@GetMapping("/getinvoicesbypharmacyandstatuscount")
	public ResponseEntity<BaseDto<Integer>> getAllInvoicesByPharmacyAndInvoiceStatusCount(@RequestParam Integer pharmacyId, @RequestParam Integer invoiceStatusId,String invoiceNo ) {
