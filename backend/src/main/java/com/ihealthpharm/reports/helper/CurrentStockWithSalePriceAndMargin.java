...
@Component
@Slf4j
public class CurrentStockWithSalePriceAndMargin implements ReportGenerator{
	...
	public void createTable(Document document, ReportsMappingModel model, List<Map<String, Object>> responseList)
		...
		table.setWidths(new int[] {25,75,35,30,40,35,35,35,35,20,25,40,40,45,35});
		...
		if (!ObjectUtils.isEmpty(responseList)) {
			for (Map<String, Object> rowData : responseList) {
				...
				value = rowData.containsKey("PURCHASE_RATE") ? rowData.get("PURCHASE_RATE") : "";
				cell = new PdfPCell(new Phrase(String.valueOf(value), title06));
				cell.setHorizontalAlignment(Element.ALIGN_LEFT);
				if (!model.isShowVerticalLines())
					cell.setBorder(Rectangle.BOTTOM);
				...
				value = rowData.containsKey("PURCHASE_DISCOUNT_RATE") ? rowData.get("PURCHASE_DISCOUNT_RATE") : "";
				cell = new PdfPCell(new Phrase(String.valueOf(value), title06));
				cell.setHorizontalAlignment(Element.ALIGN_LEFT);
				if (!model.isShowVerticalLines())
					cell.setBorder(Rectangle.BOTTOM);
				...
				value = rowData.containsKey("SALE_RATE") ? rowData.get("SALE_RATE") : "";
				cell = new PdfPCell(new Phrase(String.valueOf(value), title06));
				cell.setHorizontalAlignment(Element.ALIGN_LEFT);
				if (!model.isShowVerticalLines())
					cell.setBorder(Rectangle.BOTTOM);
				...
				value = rowData.containsKey("SALE_DISCOUNT_RATE") ? rowData.get("SALE_DISCOUNT_RATE") : "";
				cell = new PdfPCell(new Phrase(String.valueOf(value), title06));
				cell.setHorizontalAlignment(Element.ALIGN_LEFT);
				if (!model.isShowVerticalLines())
					cell.setBorder(Rectangle.BOTTOM);
				...
				value = rowData.containsKey("PACK") ? rowData.get("PACK") : "";
				cell = new PdfPCell(new Phrase(String.valueOf(value), title06));
				cell.setHorizontalAlignment(Element.ALIGN_LEFT);
				if (!model.isShowVerticalLines())
					cell.setBorder(Rectangle.BOTTOM);
				...
				value = rowData.containsKey("PURCHASE_PACK_PRICE") ? rowData.get("PURCHASE_PACK_PRICE") : "";
				cell = new PdfPCell(new Phrase(String.valueOf(value), title06));
				cell.setHorizontalAlignment(Element.ALIGN_LEFT);
				if (!model.isShowVerticalLines())
					cell.setBorder(Rectangle.BOTTOM);
				...
				value = rowData.containsKey("SALE_PACK_PRICE") ? rowData.get("SALE_PACK_PRICE") : "";
				cell = new PdfPCell(new Phrase(String.valueOf(value), title06));
				cell.setHorizontalAlignment(Element.ALIGN_LEFT);
				if (!model.isShowVerticalLines())
					cell.setBorder(Rectangle.BOTTOM);
				...
				value = rowData.containsKey("MARGIN_PER") ? rowData.get("MARGIN_PER") : "";
				cell = new PdfPCell(new Phrase(String.valueOf(value), title06));
				cell.setHorizontalAlignment(Element.ALIGN_LEFT);
				if (!model.isShowVerticalLines())
					cell.setBorder(Rectangle.BOTTOM);
