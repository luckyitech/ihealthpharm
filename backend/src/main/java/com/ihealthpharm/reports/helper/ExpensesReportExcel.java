...
@Component
public class ExpensesReportExcel extends ReportsExcelUtility{
	...
	private void createSupplierTable(SXSSFSheet sheet,File responseFile, CellStyle borderStyle ,
		...
		cell.setCellValue("EXPENSE REF NO");
		cell.setCellStyle(headerStyle);
		...
		for (Map<String, Object> rowData : accountReceivablesDetails) {
			...
			value = rowData.containsKey("EXPENSE_REF_NO") ? rowData.get("EXPENSE_REF_NO") : "";
			...
			value = rowData.containsKey("REFERENCE") ? rowData.get("REFERENCE") : "";
			...
			value = rowData.containsKey("FROM_AS_OF_DATE") ? rowData.get("FROM_AS_OF_DATE") : "";
			//sheet.autoSizeColumn(9);
			cell = dataRow.createCell(10);
			cell.setCellValue(String.valueOf(value));
			cell.setCellStyle(borderStyle);
